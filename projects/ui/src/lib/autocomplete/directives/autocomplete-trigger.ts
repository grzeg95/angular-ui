...
import {UI_FORM_FIELD} from '../../form-field/form-field';
import {UiAutocomplete} from '../autocomplete';

export const UI_AUTOCOMPLETE_SCROLL_STRATEGY = new InjectionToken<() => ScrollStrategy>(
  'ui-autocomplete-scroll-strategy',
  {
    providedIn: 'root',
    factory: () => {
...
export class UiAutocompleteTrigger {

  @Input('uiAutocomplete') autocomplete?: UiAutocomplete;
  ...
  private _formField = inject(UI_FORM_FIELD);
  private _autocompleteOptionsChangeSub?: Subscription;
  private _mutationObserverBody?: MutationObserver;
  private _scrollStrategy = inject(UI_AUTOCOMPLETE_SCROLL_STRATEGY);
